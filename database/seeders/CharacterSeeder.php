    ...
    public function run()
    {
        DB::table('characters')->insert([
            [
                ...
                'image_path' => 'images/characters/naruto.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'images/characters/sasuke.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'images/characters/sakura.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'images/characters/luffy.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'images/characters/zoro.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
